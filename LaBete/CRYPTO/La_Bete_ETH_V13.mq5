...
//|                                                                      |
//| BOT SPÉCIALISÉ ETH/USD V13 - VWAP QUALITY STRATEGY                 |
...
input string   NewsCurrency = "ETH";         // Devise à filtrer
...
int OnInit()
{
    ...
    {
        NotifyBotStarted(_Symbol, "La Bete ETH V13", "13.00");
    }
...
void AnalyzeMarket()
{
    Print("🔍 Analyse ETH/USD V12 (MA", MA_Fast, " × MA", MA_Slow, " + VWAP H1)...");
