...
//|                                                                      |
//| BOT SPÉCIALISÉ BTC/USD V13 - VWAP QUALITY STRATEGY                 |
...
int OnInit()
{
    ...
    {
        NotifyBotStarted(_Symbol, "La Bete BTC V13", "13.00");
    }
