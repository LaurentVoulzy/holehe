...
//|                                                                      |
//| BOT SPÉCIALISÉ ETH/USD V12 - VWAP QUALITY STRATEGY                 |
...
int OnInit()
{
    ...
    {
        NotifyBotStarted(_Symbol, "La Bete ETH V12", "12.00");
    }
