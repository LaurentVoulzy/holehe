...
//|                                                                      |
//| BOT SPÉCIALISÉ BTC/USD V9 - PROP FIRM ULTIMATE                     |
...
//| PARAMÈTRES INPUTS                                                 |
//+------------------------------------------------------------------+
input group "=== CONFIGURATION BTC/USD ==="
input double   RiskPercent = 0.3;           // Risque par trade (%)
input int      MagicNumber = 777001;        // Magic Number BTC
input string   TradeComment = "LaBete_BTC"; // Commentaire
...
input int      SL_MinPips = 500;             // SL minimum EUR (pips)
input int      SL_MaxPips = 1500;             // SL maximum EUR (pips)
input double   ATR_Multiplier_SL = 2.0;     // ATR × 1.5 pour EUR
...
input string   NewsCurrency = "BTC";        // Devise à filtrer (EUR pour ce bot)
...
{
    Print("╔══════════════════════════════════════════════════════════╗");
    Print("║          🐺 LA BÊTE BTC V9 ULTIMATE 🐺                   ║");
    Print("║     Système Spécialisé BTC/USD - Prop Firm Ready         ║");
    Print("║   EMA Crossover + SMC + ATR Dynamic SL/TP                ║");
    Print("╚══════════════════════════════════════════════════════════╝");

    // Vérifier qu'on est sur BTC/USD
    if(_Symbol != "EURUSD")
    {
        Print("⚠️ ATTENTION: Ce bot est optimisé pour BTC/USD uniquement!");
...
void AnalyzeMarket()
{
    Print("🔍 Analyse BTC/USD en cours...");
...
{
    Print("════════════════════════════════════════");
    Print("📈 OUVERTURE POSITION BTC/USD");
    Print("════════════════════════════════════════");
