...
//|                                                                      |
//| BOT SPÉCIALISÉ ETH/USD V9 - PROP FIRM ULTIMATE                     |
...
input int      SL_MaxPips = 200;             // SL maximum EUR (pips)
...
input string   NewsCurrency = "ETH";        // Devise à filtrer (EUR pour ce bot)
...
{
    Print("╔══════════════════════════════════════════════════════════╗");
    Print("║          🐺 LA BÊTE ETH V9 ULTIMATE 🐺                   ║");
    Print("║     Système Spécialisé ETH/USD - Prop Firm Ready         ║");
    Print("║   EMA Crossover + SMC + ATR Dynamic SL/TP                ║");
    Print("╚══════════════════════════════════════════════════════════╝");

    // Vérifier qu'on est sur ETH/USD
    if(_Symbol != "EURUSD")
    {
        Print("⚠️ ATTENTION: Ce bot est optimisé pour ETH/USD uniquement!");
...
void AnalyzeMarket()
{
    Print("🔍 Analyse ETH/USD en cours...");
...
{
    Print("════════════════════════════════════════");
    Print("📈 OUVERTURE POSITION ETH/USD");
    Print("════════════════════════════════════════");
