...
//|                                                                      |
//| BOT SPÉCIALISÉ GBP/USD V9 - PROP FIRM ULTIMATE                     |
...
input int      MagicNumber = 666002;        // Magic Number GBP
...
input string   NewsCurrency = "GBP";        // Devise à filtrer (EUR pour ce bot)
