//+------------------------------------------------------------------+
//|                                           La_Bete_GOLD_V13.mq5     |
//|                                    Copyright 2025, Yann - La Bête  |
//|                                                                      |
//| BOT SPÉCIALISÉ XAU/USD (GOLD) V13 - VWAP QUALITY STRATEGY                 |
...
input string   NewsCurrency = "XAU";         // Devise à filtrer
...
int OnInit()
{
    ...
    {
        NotifyBotStarted(_Symbol, "La Bete GOLD V12", "12.00");
    }
...
void AnalyzeMarket()
{
    Print("🔍 Analyse XAU/USD (GOLD) V12 (MA", MA_Fast, " × MA", MA_Slow, " + VWAP H1)...");
