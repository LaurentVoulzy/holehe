...
def bot_status(currency):
    ...
    try:
        ...
        # TODO: Implémenter tracking d'état par bot
        return jsonify({
            "currency": currency,
            "enabled": True,
            "open_positions": 0,
...
def bot_stats(currency):
    ...
    try:
        # Retourner les stats globales pour l'instant
...
def bot_positions(currency):
    ...
    try:
        # TODO: Implémenter tracking des positions
        return jsonify({
            "currency": currency,
            "positions": []
        })
...
def bot_enable(currency):
    ...
    try:
        # TODO: Implémenter activation/désactivation par bot
