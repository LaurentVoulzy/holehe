...
//|                                                                      |
//| BOT SPÉCIALISÉ EUR/USD V12 - VWAP QUALITY STRATEGY                 |
...
void AnalyzeMarket()
{
    Print("🔍 Analyse EUR/USD V12 (MA", MA_Fast, " × MA", MA_Slow, " + VWAP H1)...");
