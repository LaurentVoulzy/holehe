...
//|                                                                      |
//| BOT SPÉCIALISÉ USD/JPY V9 - PROP FIRM ULTIMATE                     |
...
//| PARAMÈTRES INPUTS                                                 |
//+------------------------------------------------------------------+
input group "=== CONFIGURATION USD/JPY ==="
input double   RiskPercent = 0.3;           // Risque par trade (%)
input int      MagicNumber = 666003;        // Magic Number JPY
input string   TradeComment = "LaBete_JPY"; // Commentaire
...
input int      SL_MinPips = 40;             // SL minimum EUR (pips)
input int      SL_MaxPips = 60;             // SL maximum EUR (pips)
input double   ATR_Multiplier_SL = 1.3;     // ATR × 1.5 pour EUR
...
input string   NewsCurrency = "JPY";        // Devise à filtrer (EUR pour ce bot)
...
{
    Print("╔══════════════════════════════════════════════════════════╗");
    Print("║          🐺 LA BÊTE JPY V9 ULTIMATE 🐺                   ║");
    Print("║     Système Spécialisé USD/JPY - Prop Firm Ready         ║");
    Print("║   EMA Crossover + SMC + ATR Dynamic SL/TP                ║");
    Print("╚══════════════════════════════════════════════════════════╝");

    // Vérifier qu'on est sur USD/JPY
    if(_Symbol != "EURUSD")
    {
        Print("⚠️ ATTENTION: Ce bot est optimisé pour USD/JPY uniquement!");
...
void AnalyzeMarket()
{
    Print("🔍 Analyse USD/JPY en cours...");
...
{
    Print("════════════════════════════════════════");
    Print("📈 OUVERTURE POSITION USD/JPY");
    Print("════════════════════════════════════════");
