...
echo ╔════════════════════════════════════════════════════════╗
echo ║                                                        ║
echo ║          🐺 LA BÊTE V10.1 - SYSTÈME COMPLET 🐺          ║
echo ║                                                        ║
...
echo.
echo 🚀 DÉMARRAGE LA BÊTE V10.1...
echo.

echo [1/3] 🐺 Guardian FOREX (port 5000)...
cd FOREX
start "Guardian FOREX V10.1" cmd /k "python guardian_forex.py"
cd ..
...
cd CRYPTO
start "Guardian CRYPTO V10.1" cmd /k "python guardian_crypto.py"
cd ..
timeout /t 2 /nobreak >nul
echo ✅ Guardian CRYPTO OK

echo [3/3] 📱 Bot Telegram Ultra V10.1...
cd CORE
start "Telegram Bot Ultra V10.1" cmd /k "python telegram_bot_ultra.py"
cd ..
timeout /t 2 /nobreak >nul
echo ✅ Bot Telegram Ultra V10.1 OK

echo.
echo ╔════════════════════════════════════════════════════════╗
echo ║                                                        ║
echo ║          ✅ LA BÊTE V10.1 DÉMARRÉE AVEC SUCCÈS ✅        ║
echo ║                                                        ║
...
echo ║  1. Ouvrir MT5                                         ║
echo ║  2. Charger les bots V10.1 sur charts M30:              ║
echo ║     - La_Bete_EUR_V10.1.mq5 sur EURUSD                  ║
echo ║     - La_Bete_GBP_V10.1.mq5 sur GBPUSD                  ║
echo ║     - La_Bete_JPY_V10.1.mq5 sur USDJPY                  ║
echo ║     - La_Bete_GOLD_V10.1.mq5 sur XAUUSD                 ║
echo ║     - La_Bete_BTC_V10.1.mq5 sur BTCUSD                  ║
echo ║     - La_Bete_ETH_V10.1.mq5 sur ETHUSD                  ║
...
echo ╚════════════════════════════════════════════════════════╝
echo.
echo 🐺 Que La Bête V10.1 soit avec toi! 🚀
echo.
pause
